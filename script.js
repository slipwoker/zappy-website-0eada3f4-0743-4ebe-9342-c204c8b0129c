document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      if (next && next.classList.contains('form-error-message')) {
        next.remove();
      }
    }
    ...
    animatedElements.forEach(function (el, index) {
      ...
      if (!delay) {
        ...
        for (let i = 0; i < siblings.length; i++) {
          if (siblings[i] === el) { siblingIndex = i; break; }
        }
  ...
  if (!document.getElementById(styleId)) {
    ...
    style.id = styleId;
    style.textContent = [
      '.' + ANIMATION_CLASS + '{opacity:0;transform:translateY(24px);transition:opacity 0.6s ease,transform 0.6s ease;}',
      '.' + ANIMATION_CLASS + '.' + VISIBLE_CLASS + '{opacity:1;transform:translateY(0);}',
      '.form-error-message{display:block;color:#e53e3e;font-size:0.8125rem;margin-top:0.25rem;}',
      '.field-error{border-color:#e53e3e !important;outline-color:#e53e3e !important;}'
    ].join('');
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "my-project uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0eada3f4-0743-4ebe-9342-c204c8b0129c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0eada3f4-0743-4ebe-9342-c204c8b0129c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0eada3f4-0743-4ebe-9342-c204c8b0129c';
